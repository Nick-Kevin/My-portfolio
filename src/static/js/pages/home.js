		...
		return `
			<section id="secondPage" class="accueil">
		        ...
		        <div>
			        ...
			        <div class="link other-margin-top flex-display my-my-8">
			        ...
			        <div class="footer grid-container">			        			
						<div class="flex-display flex-column">
							<p class="my-mb-2 c-white">My github contribution graph</p>
							<img
								id = "my-github-activity my-mt-1"
								class = "w-100"
						...
						<div>
	        				<p class="c-white my-mb-2">Contact me</p>
				            <div class="card">
	        			...
	        			<div>
							<p class="my-mb-2 c-white">My github streak stats</p>
							<img
								id = "my-github-streak-stats my-mt-1"
								class = "w-100"
